...
const credentialWithOptionalFields = Object.assign(Object.assign({}, minimalValidCredential), { name: 'Full Achievement Credential', description: 'This credential includes optional fields.', validUntil: validUntilDate.toISOString(), image: {
        id: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
        type: 'Image'
    } });
const invalidCredentialMissingIssuer = Object.assign(Object.assign({}, minimalValidCredential), { issuer: undefined // Force remove issuer
 });
const invalidCredentialWrongType = Object.assign(Object.assign({}, minimalValidCredential), { type: ['VerifiableCredential'] // Missing AchievementCredential type
 });
const invalidCredentialBadDate = Object.assign(Object.assign({}, credentialWithOptionalFields), { validUntil: 'not-a-date' });
// --- Tests ---
describe('v3 AchievementCredential Validation', () => {
    ...
    it('should fail validation if issuer is missing', () => {
        ...
        expect((_a = result.error) === null || _a === void 0 ? void 0 : _a.errors.some(e => e.path.includes('issuer'))).toBe(true);
    });
    it('should fail validation if type array is incorrect', () => {
        ...
        expect(result.success).toBe(false);
        expect((_a = result.error) === null || _a === void 0 ? void 0 : _a.errors.some(e => e.path.includes('type'))).toBe(true);
    });
    it('should fail validation if validUntil is not a valid date string', () => {
        ...
        expect(result.success).toBe(false);
        expect((_a = result.error) === null || _a === void 0 ? void 0 : _a.errors.some(e => e.path.includes('validUntil'))).toBe(true);
    });
    // TODO: Add more tests (evidence, proof, more complex subject/achievement variations)
});
//# sourceMappingURL=AchievementCredential.test.js.map