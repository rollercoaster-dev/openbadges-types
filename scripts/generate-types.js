...
function generateTypeName(schemaFile, specVersion) {
    if (specVersion === 'v3') {
...
function createSpecLink(baseUrl, typeName, specVersion) {
    if (specVersion === 'v3') {
...
function generateTypes(schemaDir, outputDir, specVersion, specBaseUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const schemaFile of schemaFiles) {
            ...
            try {
                let tsContent = yield compileFromFile(schemaPath, {
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Generate V3 Types
            yield generateTypes(SCHEMAS_DIR_V3, OUTPUT_DIR_V3, 'v3', SPEC_URL_V3);
            // Generate V2 Types
            yield generateTypes(SCHEMAS_DIR_V2, OUTPUT_DIR_V2, 'v2', SPEC_URL_V2);
